...
/// 
/// In this sense, this ring is strictly more general than
/// [`crate::number_ring::quotient_by_int::NumberRingQuotientByIntBase`],
/// since of course `I = (t)` an ideal generated by an integer `t` is
/// a valid choice. However, in these settings, it will be significantly
/// less performant.
/// 
